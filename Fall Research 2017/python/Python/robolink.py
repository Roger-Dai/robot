...
class Robolink:
    ...
    def AddStation(self, name="New Station"):
        ...
        In  1 (optional): string -> name of the station
        Out 1 : item -> the new station created"""
        self._check_connection()
        command = 'NewStation'
        self._send_line(command)
        self._send_line(name)
...
class Item():
    ...
    def setMillingParameters(self, ncfile='', part=0, params=''):
        """Adds a new machining project. Machining projects can also be used for 3D printing, curve following and point following.
        In  1 : string -> name of the project
        In  2 (optional): item -> curve or point object to automatically set up a curve/point follow project
        Out 1 : item -> the new item created"""
        self.link._check_connection()
    ...
    def FilterProgram(self, filestr):
        ...
        Out 1 : int -> status : 0 if the filter succeeded, <0 if there are conversion problems.
        Out 2 : string -> Summary of the filter process."""
        self.link._check_connection()
        command = 'FilterProg2'
        self.link._send_line(command)
        self.link._send_item(self)
    ...
    def Update(self):
        ...
        Out 1: Returns the number of valid instructions
